...
void interc(int x, int y){
    for(int i=0; i<3;i++)
        if(i==0){
            ...
            gotoxy(x,y+14); printf("%c", 202);
        }else if(i==2){
        gotoxy(x+10, y); printf("%c", 203);
        gotoxy(x+10, y+14); printf("%c", 202);
        }else{
...
int main()
{
    ...
    parede(20,0, 12,19,2, 1);
    interc(20,0);



    gotoxy(24, 1); cout<< "CPI";
    parede(30, 0, 12, 9, 2, 21);

    gotoxy(6,3); cout<< "Tipo-R";
    gotoxy(25, 3); cout <<R;
    parede(20,0, 12,19,4, 1);
    parede(30, 0, 12, 9, 4, 21);

    gotoxy(5,5); cout<< "Imediato";
    gotoxy(25, 5); cout <<I;
    parede(20,0, 12,19,6, 1);
    parede(30, 0, 12, 9, 6, 21);

    gotoxy(7,7); cout<< "Jump";
    gotoxy(25, 7); cout <<J;
    parede(20,0, 12,19,8, 1);
    parede(30, 0, 12, 9, 8, 21);

    gotoxy(7,9); cout<< "Load";
    gotoxy(25, 9); cout <<L;
    parede(20,0, 12,19,10, 1);
    parede(30, 0, 12, 9, 10, 21);

    gotoxy(7,11); cout<< "Save";
    gotoxy(25, 11); cout <<S;
    parede(20,0, 12,19,12, 1);
    parede(30, 0, 12, 9, 12, 21);

    gotoxy(2,13); cout<< "Nao classificado";
    gotoxy(25, 13); cout <<f;
    parede(20,0, 14,19,12, 1);
    parede(30, 0, 14, 9, 12, 21);

    gotoxy(36,1); cout<<"Outras informacoes";
    parede(51,2, 6, 20, 2, 31);
    parede(51, 2, 6, 8, 2, 52);

    gotoxy(31,3); cout <<"Total de instrucoes";
    parede(51,2, 6, 20, 4, 31);
    parede(51, 2, 6, 8, 4, 52);
    gotoxy(55, 3); cout<<N_inst;

    gotoxy(33,5); cout <<"Total de Ciclos";
    parede(51,2, 6, 20, 6, 31);
    parede(51, 2, 6, 8, 6, 52);
    gotoxy(55, 5); cout<<totalC;

    gotoxy(39, 7);cout <<"CPI";
    parede(51,2, 6, 20, 8, 31);
    parede(51, 2, 6, 8, 8, 52);
